...
export const contractorPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    {
      ...
      recommendation:
        'Add a portfolio of completed projects with before/after photos. No portfolio = no call.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'List Saskatoon neighbourhoods and surrounding communities (Martensville, Warman, etc.) served.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Display manufacturer certifications (e.g., James Hardie, CertainTeed) and trade associations.',
    },
    {
  ...
  proposalLanguage: {
    ...
    socialProof:
      "We've helped 60+ Saskatchewan contractors and home service businesses win more projects online.",
    ...
    executiveSummaryOpening:
      'Saskatoon homeowners search for contractors when they need work — your portfolio and trust signals decide who gets the call.',
  },
  ...
  locationContext: {
    ...
    currency: 'CAD',
    competitiveDensity:
      'Saskatoon has 200+ contractors and trades — your portfolio and trust signals win jobs.',
    regulatoryContext: [
