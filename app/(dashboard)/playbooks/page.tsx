  ...
  const [playbooks, setPlaybooks] = useState([
    {
      ...
      industry: 'dental',
      isDefault: true,
      description: 'Optimized for high-value patient acquisition.',
    },
    {
      id: '2',
      name: 'HVAC & Plumbing',
      industry: 'hvac',
      isDefault: true,
      description: 'Focus on emergency services and local SEO.',
    },
    {
      id: '3',
      name: 'Legal Services',
      industry: 'legal',
      isDefault: true,
      description: 'Trust-based analysis for law firms.',
    },
  ]);
