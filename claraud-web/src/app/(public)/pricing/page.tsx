        ...
        <div className="bg-[#0a0a0f] min-h-screen pt-20 pb-20">
            ...
            <SectionWrapper>
                                ...
                                >
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <div className="flex flex-col">
                                            <span className={`text-4xl font-bold ${tier.featured ? 'gradient-text' : 'text-white'}`}>
                                                ${tier.price}
                                            </span>
                                            <span className="text-text-secondary text-sm mt-1">one-time</span>
                                            {tier.priceSub && <span className="text-text-secondary text-xs mt-1">{tier.priceSub}</span>}
                                        </div>
                                    ...
                                    <Button
                                        ...
                                        className={`w-full rounded-xl py-6 h-auto font-bold transition-all ${tier.featured
                ...
                <div className="mt-32 text-center max-w-4xl mx-auto px-4">
                    <h2 className="text-4xl font-bold text-white mb-6">Every plan starts with a free scan.</h2>
