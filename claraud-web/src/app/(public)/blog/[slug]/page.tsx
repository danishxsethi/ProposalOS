...
const components = {
  h1: (props: any) => <h1 className="text-3xl md:text-4xl font-bold text-white mb-6 mt-12" {...props} />,
  h2: (props: any) => <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 mt-10" {...props} />,
  h3: (props: any) => <h3 className="text-xl md:text-2xl font-bold text-white mb-4 mt-8" {...props} />,
  p: (props: any) => <p className="text-text-secondary text-lg leading-relaxed mb-6" {...props} />,
  ul: (props: any) => <ul className="list-disc list-inside mb-6 space-y-2 text-text-secondary" {...props} />,
  ol: (props: any) => <ol className="list-decimal list-inside mb-6 space-y-2 text-text-secondary" {...props} />,
  li: (props: any) => <li className="text-lg" {...props} />,
  blockquote: (props: any) => (
    <blockquote className="border-l-4 border-blue-500 pl-6 py-2 italic bg-blue-500/5 rounded-r-xl mb-6 text-white" {...props} />
  ),
  code: (props: any) => <code className="bg-white/10 rounded px-1.5 py-0.5 text-blue-400 font-mono text-sm" {...props} />,
  pre: (props: any) => (
    <pre className="bg-[#0d1117] p-6 rounded-2xl border border-white/10 overflow-x-auto mb-8 font-mono text-sm" {...props} />
  ),
  strong: (props: any) => <strong className="text-white font-bold" {...props} />,
  a: (props: any) => <Link className="text-blue-400 hover:text-blue-300 underline transition-colors" {...props} href={props.href || '#'} />,
  ScanCTA: () => (
    ...
    <div className="bg-[#0a0a0f] min-h-screen pt-32 pb-20">
      ...
      <SectionWrapper>
        <div className="max-w-3xl mx-auto px-4">
          <Link href="/blog" className="inline-flex items-center gap-2 text-text-secondary hover:text-white transition-colors mb-12 group">
                ...
                {relatedPosts.map((p) => (
                  <Link key={p.slug} href={`/blog/${p.slug}`} className="group">
                    <div className="glass rounded-2xl p-6 border border-white/10 hover:border-blue-500/30 transition-all h-full">
                      <h3 className="text-lg font-bold text-white mb-2 group-hover:text-blue-400 transition-colors line-clamp-2">{p.title}</h3>
          ...
          <div className="mt-24 p-12 glass rounded-3xl border border-blue-500/20 text-center relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold text-white mb-4 relative z-10">Found this helpful?</h3>
            <p className="text-text-secondary mb-8 relative z-10 text-lg">Scan your business for free and get actionable insights in 30 seconds.</p>
