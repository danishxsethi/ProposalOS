        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight">
              Run this for your clients. <span className="gradient-text">Under your brand.</span>
            </h2>
            <p className="text-text-secondary mb-8 leading-relaxed">
              Agencies use Claraud to win more clients, deliver faster, and create recurring audit
              retainers. White-label the platform and make it yours.
            </p>
            ...
            <div className="glass border border-white/10 rounded-2xl p-6 space-y-4 shadow-2xl shadow-blue-500/5">
              ...
              <div className="pt-3 border-t border-white/10">
                ...
                <div className="text-xs text-text-secondary text-center">
                  ...
                  <span className="text-white">Riverside Dental</span>
                </div>
              </div>
            </div>
          </motion.div>
