    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link
          ...
          className="bg-white border border-slate-200 p-6 rounded-xl hover:shadow-md hover:border-indigo-400 transition-all"
        >
          ...
          <p className="text-slate-500 text-sm mb-4">
            Send data to Zapier, Make, or your own server.
          </p>
    ...
    <div className="bg-white border border-slate-200 p-6 rounded-xl">
      <div className="flex justify-between items-start mb-4">
        ...
        {connected ? (
          ...
          <button className="bg-slate-900 text-white px-3 py-1 rounded text-xs font-bold hover:bg-slate-800">
            Connect
          </button>
        )}
      </div>
