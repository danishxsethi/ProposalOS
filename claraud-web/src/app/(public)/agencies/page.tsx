...
import { ArrowRight, Zap, Palette, Users, BarChart3, Clock, Rocket, Bot, MousePointer2 } from 'lucide-react';
...
const problemCards = [
    {
        ...
        description: "Manual audits, custom decks, back-and-forth revisions. By the time you send it, the prospect's gone cold."
    },
    {
    ...
    },
    {
        ...
        description: "AI-native agencies are closing 3x faster with data-backed audits. You're bringing a knife to a gunfight."
    }
];
...
const featureCards = [
    {
        ...
        description: "Run a 30-dimension audit for any prospect in 30 seconds. No manual research. No guesswork."
    },
    {
        icon: <MousePointer2 className="w-8 h-8 text-blue-400" />,
        title: "Auto-Generated Proposals",
        description: "AI creates personalized proposals with your branding, pricing, and ROI projections. Just review and send."
    },
    {
        icon: <Palette className="w-8 h-8 text-purple-400" />,
        title: "White-Label Everything",
        description: "Your logo, your colors, your domain. Clients never see 'Claraud'. It's your tool."
    },
    {
        icon: <Users className="w-8 h-8 text-green-400" />,
        title: "Client Portal",
        description: "Each client gets their own login with reports, progress tracking, and invoices. Professional and hands-off."
    },
    {
        icon: <Rocket className="w-8 h-8 text-orange-400" />,
        title: "Delivery Engine",
        description: "AI generates the actual fix artifacts — schema markup, meta tags, content briefs, GBP drafts. Not just recommendations."
    },
    {
        icon: <BarChart3 className="w-8 h-8 text-pink-400" />,
        title: "Analytics Dashboard",
        description: "Pipeline value, conversion rates, revenue per audit, module performance. Know your numbers."
    }
];
    ...
    return (
        <div className="bg-[#0a0a0f] min-h-screen">
            ...
            <div className="relative pt-32 pb-20 overflow-hidden">
                ...
                <SectionWrapper>
                    <div className="text-center max-w-4xl mx-auto px-4 relative z-10">
                        ...
                        >
                            Claraud gives your agency AI-powered audit reports, personalized proposals, and autonomous delivery — all under your brand.
                        </motion.p>
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
            ...
            <SectionWrapper className="py-24 bg-white/5">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Everything your agency needs to win.</h2>
                </div>
            ...
            <SectionWrapper className="py-24">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">See what Claraud does to your bottom line.</h2>
                </div>
                <ROICalculator />
            </SectionWrapper>
            ...
            <SectionWrapper className="py-24 bg-white/5">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Simple pricing. Unlimited upside.</h2>
                </div>
                <AgencyTiers />
            ...
            <SectionWrapper className="py-32 bg-gradient-to-t from-blue-600/10 to-transparent">
                <div className="text-center max-w-4xl mx-auto px-4">
                    <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">Your next client is searching for help right now.</h2>
                    ...
                    <Button
                        ...
                        onClick={() => captureEvent('agency_trial_clicked')}
                    >
                        <Link href="/pricing">Start your free 14-day trial <ArrowRight className="ml-2 w-6 h-6" /></Link>
                    </Button>
                </div>
            </SectionWrapper>
        </div>
