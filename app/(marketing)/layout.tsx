      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-slate-950/80 backdrop-blur-xl">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <nav className="hidden md:flex gap-6 text-sm font-medium text-slate-400">
            <Link href="/for-agencies" className="hover:text-white transition">
              For Agencies
            </Link>
            <Link href="/demo/sample-report" className="hover:text-white transition">
              Sample Report
            </Link>
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/login"
              className="text-sm font-medium text-white hover:text-indigo-400 transition hidden sm:block"
            >
              Log In
            </Link>
            <Link
              href="/free-audit"
              className="bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 rounded-lg text-sm font-bold transition shadow-lg shadow-indigo-500/20"
            >
              Get Free Score
            </Link>
          </div>
      ...
      <footer className="border-t border-white/5 bg-slate-900/50 py-12">
        <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-4 gap-8 text-sm">
          <div className="space-y-4">
            ...
            <p className="text-slate-500">The standard for automated digital auditing.</p>
          </div>
          <div>
            <h4 className="font-bold text-white mb-4">Product</h4>
            <ul className="space-y-2 text-slate-500">
              <li>
                <Link href="/for-agencies" className="hover:text-indigo-400">
                  For Agencies
                </Link>
              </li>
              <li>
                <Link href="/demo/sample-report" className="hover:text-indigo-400">
                  Sample Report
                </Link>
              </li>
              <li>
                <Link href="/docs/api" className="hover:text-indigo-400">
                  API Docs
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-500">
              ...
              <li>
                <Link href="/free-audit" className="hover:text-indigo-400">
                  Free Audit
                </Link>
              </li>
              <li>
