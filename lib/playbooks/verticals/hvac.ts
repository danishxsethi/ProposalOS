...
export const hvacPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    {
      ...
      recommendation:
        'Place the emergency number in a sticky header or above-the-fold banner on mobile.',
    },
    {
      ...
      recommendation:
        'Create a service area page listing Saskatoon neighbourhoods (Downtown, Nutana, Stonebridge, etc.).',
    },
    {
      id: 'seasonal_content',
      ...
      recommendation:
        'Add seasonal landing pages — Saskatchewan winters demand furnace readiness; summers need AC.',
    },
    {
      ...
      recommendation:
        'Display Saskatchewan contractor licence, liability insurance, and bonding badges.',
    },
    {
      ...
      recommendation:
        'Add a portfolio of furnace installs, AC replacements, and ductwork projects.',
    },
    {
      ...
      recommendation:
        'Add a simple quote request form (project type, contact info) above the fold.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Add financing options (e.g., Synchrony, Affirm) to reduce purchase friction.',
    },
    {
  ...
  proposalLanguage: {
    ...
    socialProof:
      "We've helped 40+ Saskatchewan HVAC companies capture more emergency calls and seasonal tune-up bookings.",
    urgencyHook:
      "When someone's furnace breaks at 10pm in Saskatchewan winter, they're searching on their phone. You have 3 seconds.",
    roiFraming: 'Each emergency furnace call can lead to $400–$2,000+ in repairs or replacement.',
    executiveSummaryOpening:
      'Saskatchewan winters are unforgiving — homeowners searching for HVAC help need to find you fast.',
  },
  ...
  locationContext: {
    ...
    currency: 'CAD',
    competitiveDensity:
      'Saskatoon has 60+ HVAC and plumbing businesses — emergency visibility is critical.',
    regulatoryContext: [
