...
export const lawFirmPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    {
      ...
      recommendation:
        'Create dedicated pages for each practice area (e.g., Personal Injury, Family Law, Real Estate) with targeted content.',
    },
    {
      ...
      severity: 'critical',
      description:
        'Are attorney bios with photo, credentials, and Saskatchewan bar admission displayed?',
      recommendation:
        'Display bar membership, years of experience, and credentials on attorney bio pages.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Feature client testimonials and case results with appropriate legal disclaimers.',
    },
    {
      ...
      recommendation:
        'Optimise for "lawyer Saskatoon" and practice-area + city combinations in titles and content.',
    },
    {
      ...
      severity: 'high',
      description:
        'Are trust signals (Saskatchewan Law Society, awards, years of practice) displayed?',
    ...
    },
    {
      ...
      recommendation:
        'Ensure WCAG 2.1 compliance — law firms face higher accessibility litigation risk.',
    },
    {
      id: 'pipeda_privacy',
  ...
  proposalLanguage: {
    ...
    socialProof:
      "We've helped 30+ Saskatchewan law firms rank higher and convert more online inquiries into clients.",
    ...
    executiveSummaryOpening:
      'Saskatoon clients searching for legal help compare multiple firms online before contacting one.',
  },
  ...
  locationContext: {
    ...
    currency: 'CAD',
    competitiveDensity:
      'Saskatoon has 100+ law firms — your website is often the first impression.',
    regulatoryContext: [
      'PIPEDA (client privacy)',
