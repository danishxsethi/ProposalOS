  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Link
        ...
        className="text-slate-500 text-sm hover:text-indigo-600 mb-4 inline-block"
      >
                ...
                <td className="px-6 py-4">
                  <div className="flex gap-1 flex-wrap">
                    {wh.events.map((e) => (
                      <span
                        key={e}
                        className="bg-slate-100 text-slate-600 px-2 py-0.5 rounded textxs"
                      >
                        {e}
                      </span>
                    ))}
      ...
      <div className="mt-8 bg-slate-50 p-6 rounded-xl border border-slate-200">
        ...
        <div className="font-mono text-xs bg-slate-900 text-white p-4 rounded-lg overflow-x-auto">
          X-ProposalOS-Signature: sha256=757...
          <br />
