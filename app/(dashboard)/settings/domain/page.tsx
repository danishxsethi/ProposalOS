      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-8">
        ...
        {status === 'verified' && (
          <div className="bg-green-500/20 border border-green-500/50 rounded-lg p-4 mb-6">
            <h3 className="text-green-400 font-bold flex items-center gap-2">✓ Domain Verified</h3>
            <p className="text-slate-300 mt-2">
              Your proposals are now live at{' '}
              <a href={`https://${domain}`} target="_blank" className="underline hover:text-white">
                https://{domain}
              </a>
            </p>
          </div>
