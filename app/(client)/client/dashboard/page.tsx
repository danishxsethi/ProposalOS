    ...
    <div className="max-w-5xl mx-auto">
      <header className="mb-8">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-slate-500">Here is the live status of your digital growth plan.</p>
          </div>
          <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-sm text-right">
            ...
            <div className="text-xs text-slate-500">
              {fixedCount} of {totalFindings} Critical Issues Fixed
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-8">
        ...
        <p className="text-indigo-800 mb-6">
          We are currently working on fixing your <strong>Website Speed</strong> and{' '}
          <strong>Local SEO</strong>. Expected completion: Friday.
        </p>
...
function DashboardCard({
  ...
  return (
    <Link
      href={href}
      className="group bg-white border border-slate-200 hover:border-indigo-400 hover:shadow-md p-6 rounded-xl transition-all"
    >
      <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300 origin-left">
        {icon}
      </div>
      <h3 className="font-bold text-slate-900 text-lg mb-2 group-hover:text-indigo-600">
        {title} &rarr;
      </h3>
