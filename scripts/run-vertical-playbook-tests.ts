...
const VERTICAL_TEST_BUSINESSES = [
  {
    name: 'Saskatoon Family Dental',
    city: 'Saskatoon',
    url: 'https://www.wikipedia.org',
    industry: 'dentist',
  },
  {
    name: 'Prairie Law Group',
    city: 'Saskatoon',
    url: 'https://www.wikipedia.org',
    industry: 'law firm',
  },
  {
    name: 'Bridge City Heating & Cooling',
    city: 'Saskatoon',
    url: 'https://www.wikipedia.org',
    industry: 'hvac',
  },
  ...
  {
    name: 'Stonebridge Realty',
    city: 'Saskatoon',
    url: 'https://www.wikipedia.org',
    industry: 'real estate agent',
  },
  {
    name: 'Nutana Fitness Centre',
    city: 'Saskatoon',
    url: 'https://www.wikipedia.org',
    industry: 'gym',
  },
  {
    name: 'Prairie Pet Veterinary Clinic',
    city: 'Saskatoon',
    url: 'https://www.wikipedia.org',
  ...
  {
    name: 'Saskatoon Home Renovations',
    city: 'Saskatoon',
    url: 'https://www.wikipedia.org',
    industry: 'contractor',
  },
  {
    name: 'River Landing Retail',
    city: 'Saskatoon',
    url: 'https://www.wikipedia.org',
    industry: 'retail',
  },
  ...
  const logPayload = {
    ...
    results: results.map((r) => {
      ...
      return {
        ...
        painClusters: p?.painClusters?.map((c) => ({
