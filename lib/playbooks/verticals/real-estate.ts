...
export const realEstatePlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    ...
    },
    {
      ...
      recommendation:
        'Create neighbourhood pages (Nutana, Broadway, Stonebridge, Evergreen, etc.) to capture "homes in [area]" searches.',
    },
    {
      ...
      recommendation:
        'Optimise listing images (WebP, lazy load) and ensure pages load under 3 seconds.',
    },
    {
      ...
      recommendation:
        'Add prominent lead capture forms: home valuation, buyer inquiry, contact agent.',
    },
    {
      id: 'agent_bio_trust',
      ...
      recommendation:
        'Add agent bio with photo, credentials, designations, and recent sales/testimonials.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Ensure listing photos, details, and contact forms work seamlessly on mobile.',
    },
    {
      ...
      recommendation:
        'Add blog posts on Saskatoon neighbourhoods and market trends to build authority.',
    },
  ],
  ...
  proposalLanguage: {
    ...
    socialProof:
      "We've helped 25+ Saskatchewan real estate agents and teams generate more leads from their websites.",
    urgencyHook:
      'Buyers spend 3+ hours online before contacting an agent. Your website is your first showing.',
    roiFraming: 'Each lead from your website can represent $10,000+ in commission.',
    executiveSummaryOpening:
      'Saskatoon home buyers and sellers compare agents online before making contact.',
  },
