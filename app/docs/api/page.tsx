      ...
      <div className="max-w-6xl mx-auto grid grid-cols-12 gap-8">
        ...
        <div className="col-span-3">
          ...
          <div className="space-y-2">
            <button className="block w-full text-left px-4 py-2 rounded bg-slate-900 text-white">
              Reference
            </button>
            <button className="block w-full text-left px-4 py-2 rounded hover:bg-slate-900 text-slate-400">
              Authentication
            </button>
            <button className="block w-full text-left px-4 py-2 rounded hover:bg-slate-900 text-slate-400">
              Rate Limits
        ...
        <div className="col-span-9 space-y-12">
          <section>
            ...
            <p className="text-slate-400 mb-4">
              Authenticate requests by passing your API Key in the{' '}
              <code className="text-indigo-300">Authorization</code> header.
            </p>
