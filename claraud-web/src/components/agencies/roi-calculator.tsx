      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="space-y-6 relative z-10">
            <div>
              <p className="text-text-secondary text-sm uppercase tracking-widest font-bold mb-1">
                Without Claraud
              </p>
              <p className="text-2xl font-bold text-white/70">
                <AnimatedCounter value={withoutClaraud} prefix="$" />
                /mo
              </p>
            </div>

            <div>
              <p className="text-blue-400 text-sm uppercase tracking-widest font-bold mb-1">
                With Claraud (Projected {projectedCloseRate.toFixed(0)}% Close Rate)
              </p>
              <p className="text-3xl font-bold text-white">
                <AnimatedCounter value={withClaraud} prefix="$" />
                /mo
              </p>
            </div>
            ...
            <div className="pt-6 border-t border-white/10">
              ...
              <div className="text-3xl md:text-4xl font-bold gradient-text">
                <AnimatedCounter value={additionalRevenue} prefix="$" />
                /mo
              </div>
              <div className="text-lg font-semibold text-text-secondary mt-1">
                → <AnimatedCounter value={additionalRevenue * 12} prefix="$" />
                /year
              </div>
            </div>
          </div>
