    ...
    <div className="bg-slate-950 min-h-screen">
      <section className="pt-24 pb-16 px-4 text-center">
        ...
        <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">
          White-label the world's most advanced digital audit engine. Impress clients, close wins,
          and scale your agency without adding headcount.
        </p>
        <Link
          href="/register"
          className="bg-white text-slate-900 px-8 py-4 rounded-xl font-bold text-lg hover:bg-slate-200 transition"
        >
      ...
      <section className="py-24 text-center">
        <Link
          href="/register"
          className="text-indigo-400 hover:text-white text-2xl font-bold transition"
        >
