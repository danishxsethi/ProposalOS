        ...
        <div className="p-8 h-full min-h-[calc(100vh-4rem)] flex flex-col space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex-1 overflow-x-auto pb-4">
                <div className="flex gap-6 min-w-max h-full">
                    {[1, 2, 3, 4, 5].map((col) => (
                        <div key={col} className="w-[350px] bg-bg-card rounded-2xl border border-white/5 flex flex-col p-4 shadow-xl">
                            ...
                            <div className="space-y-4 flex-1">
                                {[1, 2].map((card) => (
                                    <div key={card} className="bg-white/5 border border-white/10 p-4 rounded-xl space-y-4">
