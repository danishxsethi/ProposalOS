  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <MetricCard
          label="Total Audits"
          value={northStar.totalAudits}
          change={`+${growth.auditsLast30Days}`}
        />
        <MetricCard
          label="Total Users"
          value={northStar.totalUsers}
          change={`+${growth.usersLast30Days}`}
        />
...
function MetricCard({
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl">
      ...
      {change && <div className="text-xs font-bold text-green-400 mt-1">{change} vs last mo</div>}
    </div>
  );
}
