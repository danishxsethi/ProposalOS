      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-text-secondary mt-1">
            Manage and view your generated business audits.
          </p>
        </div>
        <Button
          asChild
                ...
                {isLoading ? (
                  ...
                  data.audits.map((audit: any, i: number) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-2.5 py-1 rounded-full text-xs font-medium border ${getStatusColor(audit.status)}`}
                        >
                          {audit.status}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4 text-text-secondary">{audit.findingsCount}</td>
