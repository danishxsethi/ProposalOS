      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-400">
            Embed this widget on your agency website to capture leads automatically.
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-6">
          ...
          <div className="p-4 bg-indigo-500/10 border border-indigo-500/30 rounded-lg">
            ...
            <p className="text-xs text-slate-300">
              ...
              <code className="bg-indigo-900/50 px-1 rounded">&lt;/body&gt;</code> tag on your
              website. It works with WordPress, Webflow, Squarespace, and custom sites.
            </p>
          </div>
        </div>
        ...
        <div className="relative bg-white border border-slate-200 rounded-xl overflow-hidden h-[500px]">
          <div className="absolute top-0 left-0 right-0 h-8 bg-slate-100 border-b flex items-center px-4 gap-2">
            ...
            <div className="ml-4 text-xs text-slate-400 bg-white px-2 py-0.5 rounded border">
              youragency.com
            </div>
          </div>
          ...
          <div className="p-8 mt-8">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              We Build Great Digital Experiences
            </h2>
          ...
          <div
            className="absolute bottom-5 right-5 w-14 h-14 rounded-full border-2 border-white animate-ping opacity-20 pointer-events-none"
            style={{ backgroundColor: color }}
          ></div>
        </div>
      </div>
