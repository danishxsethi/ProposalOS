        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Section style={roiSection}>
              ...
              <Text style={roiText}>
                Fixing just the top 3 issues could mean{' '}
                <strong style={roiBold}>${roiProjection.toLocaleString()}</strong>
            ...
            <Section style={urgencySection}>
              <Text style={urgencyText}>
                Your audit data is valid for 21 days. After that, you'll need to re-scan as your
