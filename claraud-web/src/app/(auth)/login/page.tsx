                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <span tabIndex={0}>
                                    <Button variant="outline" className="w-full bg-white/5 border-white/10 text-text-secondary hover:text-white hover:bg-white/10 cursor-not-allowed opacity-50 font-normal">
