...
export const dentistPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    {
      ...
      severity: 'critical',
      description:
        'Does the site have an online scheduling widget? Online booking is now expected by patients.',
      recommendation:
        'Add an online scheduling widget (e.g., Luma, Jane, or embedded Calendly) so patients can book 24/7.',
    },
    {
      ...
      recommendation:
        'Display the emergency/after-hours number above the fold on mobile and in the header.',
    },
    {
      ...
      severity: 'high',
      description:
        'Is there a dedicated page listing accepted insurance plans and payment options?',
      recommendation:
        'Create a dedicated page listing accepted insurance plans (including Saskatchewan health coverage) and payment options.',
    },
    {
      ...
      recommendation:
        'Add a before/after gallery with a PIPEDA-compliant consent notice. Visual proof builds trust.',
    },
    {
      ...
      severity: 'high',
      description:
        'Is a new patient offer or promotion visible (e.g., free exam, whitening special)?',
      recommendation:
        'Promote new patient offers (free exam, whitening) above the fold to capture first-time visitors.',
    },
    {
      ...
      severity: 'high',
      description:
        'Are Google reviews being responded to? Patients check reviews before choosing a dentist.',
      recommendation:
        'Respond to all Google reviews — 89% of patients read business responses before booking.',
    },
    {
      ...
      recommendation:
        'Add a testimonials section with Google reviews or patient quotes to build trust.',
    },
    {
      id: 'provider_bios',
    ...
    },
    {
      ...
      recommendation:
        'Ensure WCAG 2.1 compliance and a clear privacy policy for patient data (PIPEDA).',
    },
  ],
  ...
  proposalLanguage: {
    ...
    socialProof:
      "We've helped 50+ dental practices in Saskatchewan improve their online presence and fill more chairs.",
    urgencyHook:
      'Patients searching for dentists in Saskatoon decide in under 10 seconds on their phone.',
    roiFraming: 'Every patient you lose to a competitor represents $3,000+ in lifetime value.',
    executiveSummaryOpening:
      'With 47+ dental practices in Saskatoon, your online presence determines whether new patients choose you or a competitor.',
  },
