...
export const salonPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    {
      ...
      recommendation:
        'Use a fast, mobile-friendly booking system (Vagaro, Fresha, Booksy, Square) that loads quickly.',
    },
    {
      ...
      recommendation:
        'Add a gallery with before/after photos, styles, and colour work. Consider Instagram integration.',
    },
    {
      ...
      recommendation:
        'Create pages for each stylist/technician with photo, specialties, and booking link.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Ensure booking loads fast and works on mobile — most clients book on their phone.',
    },
    {
  ...
  proposalLanguage: {
    ...
    socialProof:
      "We've helped 55+ Saskatchewan salons and spas attract more clients and fill their books.",
    urgencyHook:
      '80% of salon clients book after seeing your work online. Your portfolio IS your storefront.',
    roiFraming: 'Each new client represents $95+ in average service value.',
    executiveSummaryOpening:
      'Saskatoon clients discover salons on Instagram and Google — your portfolio and booking UX decide who books.',
  },
  ...
  locationContext: {
    ...
    regulatoryContext: [
      'Provincial cosmetology licensing',
      'PIPEDA (client data)',
      'CASL (promotions)',
    ],
  },
