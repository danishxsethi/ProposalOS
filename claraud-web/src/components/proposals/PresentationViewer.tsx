...
import { CheckCircle, ChevronLeft, ChevronRight, Maximize, Play, X } from 'lucide-react';
...
export default function PresentationViewer({ proposal, branding }: Props) {
  ...
  return (
    <div
      className={`fixed inset-0 bg-black flex flex-col \${isFullscreen ? "z-[9999]" : "z-50 mt-16"}`}
    >
      {/* Header / Controls */}
      ...
      <div className="flex-1 relative overflow-hidden flex items-center justify-center">
            ...
            <div className="w-full max-w-6xl aspect-video bg-[#111111] rounded-2xl shadow-2xl border border-white/10 overflow-hidden relative flex flex-col">
              ...
              {slides[currentSlide].type === 'title' && (
                <div className="flex-1 flex flex-col items-center justify-center text-center p-12 relative overflow-hidden">
                  ...
                  />
                  <h2 className="text-xl md:text-2xl font-medium text-text-secondary tracking-widest uppercase mb-4 z-10">
                    Strategic Audit & Proposal
                  </h2>
                  <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 z-10">
                ...
                <div className="flex-1 flex flex-col p-12 md:p-20">
                  ...
                  <div className="text-2xl text-text-secondary leading-relaxed bg-white/5 p-10 rounded-2xl border border-white/10 flex-1">
                    {proposal.executiveSummary ||
                      'Based on our comprehensive analysis, we have identified key areas of opportunity to enhance your digital presence, improve performance, and drive measurable revenue growth.'}
                  </div>
                </div>
              )}
                ...
                <div className="flex-1 flex flex-col p-12 md:p-20">
                  ...
                  <div className="grid grid-cols-2 gap-6 flex-1">
                    {proposal.audit.findings?.slice(0, 4).map((finding: any, idx: number) => (
                      <div
                        key={idx}
                        className="bg-white/5 border border-white/10 p-6 rounded-xl flex flex-col"
                      >
                      ...
                      <div className="col-span-2 flex items-center justify-center text-text-secondary">
              ...
              {slides[currentSlide].type === 'solution' && (
                <div className="flex-1 flex flex-col p-12 md:p-20">
                  ...
                  <p className="text-xl text-text-secondary text-center mb-12">
                    Tailored approaches to achieve your specific goals.
                  </p>
                  <div className="grid grid-cols-3 gap-8 flex-1">
                    ...
                    <div className="bg-accent-primary/10 border border-accent-primary/50 p-8 rounded-2xl flex flex-col transform scale-105 shadow-2xl relative">
                      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-accent-primary text-white px-4 py-1 rounded-full text-sm font-bold">
                        RECOMMENDED
                      </div>
                      <h3
                  ...
                  <div className="grid grid-cols-3 gap-12 w-full max-w-4xl">
                    <div className="text-center">
                      ...
                      <div className="text-5xl font-bold text-white">
                        ${(proposal.pricing as any)?.starter || 0}
                      </div>
                    ...
                    <div className="text-center p-8 rounded-2xl border border-accent-primary/30 relative">
                      ...
                      <h3 className="text-2xl" style={{ color: primaryColor }}>
                        Growth
                      </h3>
                      <div className="text-6xl font-bold text-white my-4">
                        ${(proposal.pricing as any)?.growth || 0}
                      </div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-5xl font-bold text-white">
                        ${(proposal.pricing as any)?.premium || 0}
                      </div>
                      <div className="text-sm text-text-secondary mt-2">/ month</div>
                    </div>
                  </div>
              ...
              {slides[currentSlide].type === 'next-steps' && (
                <div className="flex-1 flex flex-col items-center justify-center text-center p-12 relative overflow-hidden">
                  ...
                  <p className="text-2xl text-text-secondary mb-12 max-w-2xl">
                    Choose your desired tier and sign the agreement to kick off the partnership and
                    begin onboarding.
                  </p>
                  <Button
                    size="lg"
                    className="bg-accent-primary hover:bg-accent-primary/90 text-white text-xl px-12 py-8 rounded-full shadow-2xl shadow-accent-primary/30"
                    onClick={() => (window.location.href = `/proposal/\${proposal.webLinkToken}`)}
                  >
                    Open Checkout
                  </Button>
                </div>
        ...
        <div
          className="absolute inset-y-0 left-0 w-1/6 cursor-w-resize z-40 hidden md:block"
          onClick={prevSlide}
        />
        <div
          className="absolute inset-y-0 right-0 w-1/6 cursor-e-resize z-40 hidden md:block"
          onClick={nextSlide}
        />
      </div>
      ...
      <div className="h-20 bg-black/50 z-50 flex items-center justify-center gap-6 p-4">
        <Button
          variant="outline"
          size="lg"
          className="bg-transparent border-white/20 text-white hover:bg-white/10 rounded-full w-14 h-14 p-0"
          onClick={prevSlide}
