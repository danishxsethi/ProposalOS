      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={intro}>We dug deeper into your audit results. Here's what we found:</Text>
            ...
            <Section style={meansSection}>
              ...
              <Text style={meansText}>
                This issue is actively preventing potential customers from finding and choosing your
                business. Every day this remains unresolved, you're losing leads to competitors who
                have optimized their online presence.
              </Text>
            </Section>
              ...
              <Row style={scenarioRow}>
                <Column style={scenarioCol}>
                  ...
                  <Text style={scenarioText}>
                    ...
                    <br />• Losing {Math.round((competitorScore - yourScore) / 10)} leads/month
                    <br />• Competitors outranking you on key searches
                  </Text>
                </Column>
                <Column style={scenarioCol}>
                  ...
                  <Text style={scenarioText}>
                    ...
                    <br />
                    • Recover lost leads
                    <br />• Rank higher on local searches
                  </Text>
                </Column>
              </Row>
            </Section>
