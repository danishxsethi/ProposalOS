...
// Replace `getGeminiModel(...)` calls below with `await getOrchestratedModel('proposal_writing')`
// to route through selectModel() + executeWithFallback() for dynamic model selection and failover.
// Import: import { getOrchestratedModel } from '@/lib/llm/gemini';
