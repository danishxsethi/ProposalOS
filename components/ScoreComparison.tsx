  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 mb-8">
      ...
      <div className="flex items-center gap-6">
        <div className="flex-1">
          ...
          <div className="h-2 bg-slate-800 rounded-full overflow-hidden relative">
            ...
            {/* Markers for average */}
            <div
              className="absolute top-0 bottom-0 w-1 bg-yellow-500 left-[65%]"
              title="Industry Avg"
            />
          </div>
      ...
      <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg text-sm text-yellow-200 flex gap-3">
        ...
        <p>
          You are currently in the <strong>bottom {percentile}%</strong> of {industry} businesses in{' '}
          {city}. Competitors are actively optimizing their profiles.
        </p>
      </div>
    </div>
  );
