...
export const predictiveGraph = new StateGraph(PredictiveState)
    ...
    .addNode('rankingTrajectory', rankingTrajectoryNode)
    .addNode('competitorThreat', competitorThreatNode)
    .addNode('revenueImpact', revenueImpactNode)
    .addNode('algorithmRisk', algorithmRiskNode)
    ...
    .addEdge('gatherSignals', 'competitorThreat')
    .addEdge('gatherSignals', 'algorithmRisk')
    .addEdge('forecastTraffic', 'rankingTrajectory')
    .addEdge('rankingTrajectory', 'revenueImpact')
    .addEdge('revenueImpact', 'renderPredictiveOutlook')
    .addEdge('competitorThreat', 'renderPredictiveOutlook')
    .addEdge('algorithmRisk', 'renderPredictiveOutlook')
