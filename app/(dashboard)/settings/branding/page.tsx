          ...
          <Section title="Identity">
            ...
            <Field label="Tagline">
              <input
                ...
                onChange={handleChange}
                className="input-dark w-full"
                placeholder="e.g. Digital Growth Experts"
              />
            </Field>
            <Field label="Logo">
        ...
        <div className="sticky top-10">
          ...
          <div className="border border-slate-700 rounded-xl overflow-hidden bg-white shadow-2xl">
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  {config.logoUrl ? (
                    ...
                    <div className="h-10 w-10 bg-white/20 rounded flex items-center justify-center font-bold">
                      L
                    </div>
                  )}
                ...
                <div className="text-sm opacity-90">
                  {config.contactEmail || 'contact@example.com'}
                </div>
              </div>
              <div className="mt-8">
            ...
            <div className="p-8 bg-gray-50 min-h-[400px]">
              ...
              <div
                className="p-4 bg-white rounded shadow-sm border border-gray-100 flex gap-4 border-l-4"
