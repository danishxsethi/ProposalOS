...
export default async function ClientReviewsPage({
  ...
  const reviews = [
    ...
    },
    {
      ...
      response:
        "Hi Sarah, thanks for the feedback! We're actually adding 5 new dedicated spots next week. Hope to see you again!",
    },
  ];
        ...
        {reviews.map((r, i) => (
          <div key={i} className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-lg p-4">
              <div className="text-xs font-bold text-indigo-800 uppercase mb-2">
                Suggested Response
              </div>
