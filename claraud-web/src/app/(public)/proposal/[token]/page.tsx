        ...
        return (
            <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
                <div className="glass border border-red-500/20 rounded-2xl p-8 max-w-md text-center">
                    ...
                    <p className="text-text-secondary mb-6">Proposal not found. Your audit may still be processing.</p>
                    ...
                    <div className="space-y-4">
                        ...
                        {proposal?.tierEssentials && (
                            <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
                                ...
                                <p className="text-text-secondary">Starting at ${proposal.pricing?.tierEssentials?.price || 'N/A'}/mo</p>
                            </div>
                        )}
                        ...
                        {proposal?.tierGrowth && (
                            <div className="p-4 bg-purple-500/10 border border-purple-500/20 rounded-xl">
                                ...
                                <p className="text-text-secondary">Starting at ${proposal.pricing?.tierGrowth?.price || 'N/A'}/mo</p>
                            </div>
                        )}
                        ...
                        {proposal?.tierPremium && (
                            <div className="p-4 bg-orange-500/10 border border-orange-500/20 rounded-xl">
                                ...
                                <p className="text-text-secondary">Starting at ${proposal.pricing?.tierPremium?.price || 'N/A'}/mo</p>
                            </div>
                        )}
                    </div>
                </div>
