...
export const gymPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    {
      ...
      recommendation:
        'Display class schedules prominently with real-time updates. Link to booking or show availability.',
    },
    {
      ...
      recommendation:
        'Add an online membership signup flow — reduce friction and capture leads 24/7.',
    },
    {
      id: 'free_trial_cta',
    ...
    },
    {
      ...
      recommendation:
        'Feature transformation stories, before/after photos, and member quotes to build trust.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Upload 15+ photos (facility, equipment, classes, team) to your Google Business Profile.',
    },
    {
  ...
  proposalLanguage: {
    ...
    socialProof:
      "We've helped 40+ Saskatchewan gyms and fitness studios fill more memberships online.",
    urgencyHook:
      '73% of gym members research online before signing up. A slow or confusing site kills conversions.',
    roiFraming: 'Each new member represents $55+ per month in recurring revenue.',
    executiveSummaryOpening:
      'Saskatoon fitness seekers compare gyms online — your site and Google presence decide who joins.',
  },
