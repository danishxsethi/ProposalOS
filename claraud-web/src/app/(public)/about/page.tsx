    ...
    <div className="bg-[#0a0a0f] min-h-screen pt-20">
      ...
      <SectionWrapper>
        <div className="max-w-4xl mx-auto px-4 py-16 md:py-24">
          ...
          >
            <p>
              Most small businesses get one of two things: a $5,000 agency retainer that delivers a
              PowerPoint deck, or free advice from the internet that's generic, outdated, and wrong.
            </p>
            <p>
              We built Claraud to give every business the same quality audit that Fortune 500
              companies get — but in 30 seconds, not 30 days. And for free.
            </p>
            <p>
              Our AI engine analyzes 30+ dimensions of your online presence — website performance,
              Google Business Profile, SEO, reviews, social media, and competitive landscape — then
              builds a personalized action plan ranked by impact.
            </p>
          </motion.div>
        </div>
      </SectionWrapper>
        ...
        <div className="max-w-6xl mx-auto px-4 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {team.map((member, idx) => (
              ...
              >
                <div
                  className={`w-24 h-24 rounded-full flex-shrink-0 bg-gradient-to-br ${member.gradient} flex items-center justify-center text-2xl font-bold text-white shadow-xl shadow-blue-500/10`}
                >
                  {member.initials}
                </div>
                <div className="text-center md:text-left">
                  <h3 className="text-2xl font-bold text-white mb-1">{member.name}</h3>
                  <p className="text-blue-400 font-semibold mb-4 uppercase tracking-widest text-xs">
                    {member.role}
                  </p>
        ...
        <div className="max-w-4xl mx-auto px-4 py-24 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-12 mb-20">
            ...
            >
              ...
              <div>
                <p className="text-text-secondary text-sm font-bold uppercase tracking-widest mb-1">
                  Email us
                </p>
          ...
          <div className="glass p-12 rounded-[40px] border border-blue-500/20">
            <h3 className="text-2xl font-bold text-white mb-6">
              Or just scan your business — we'll be in touch →
            </h3>
