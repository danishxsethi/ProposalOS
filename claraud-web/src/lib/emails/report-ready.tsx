...
export function ReportReadyEmail({
  ...
  const brandPrimary = branding?.colors?.primary || '#3b82f6';
  const brandName = branding?.name || 'Claraud';
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={header}>
            {branding?.logoUrl ? (
              <img src={branding.logoUrl} alt={brandName} style={logoImage} />
            ) : (
              <Text style={{ ...logo, color: brandPrimary }}>{brandName}</Text>
            )}
          </Section>
          ...
          <Section style={content}>
            ...
            <Text style={intro}>
              Your AI audit of <strong style={bold}>{businessName}</strong> is complete. Here's a
              snapshot:
            </Text>
            ...
            <Section style={{ ...scoreCard, borderColor: scoreColor }}>
              <Row>
                ...
                <Column align="center">
                  <Text
                    style={{ ...gradeBadge, color: scoreColor, backgroundColor: `${scoreColor}20` }}
                  >
                    {letterGrade}
                  </Text>
                </Column>
                ...
                return (
                  <Row key={cat.id} style={categoryRow}>
                    ...
                    <Column align="right" style={categoryScoreCol}>
                      <Text style={{ ...categoryScore, color: catColor }}>
              ...
              {topFindings.slice(0, 3).map((finding, idx) => (
                <Row key={idx} style={findingRow}>
                  <Column style={findingEmojiCol}>
                    <Text style={findingEmoji}>{severityEmoji[finding.severity] || '🟡'}</Text>
                  </Column>
            ...
            <Text style={footerIntro}>
              This report was generated by Claraud's AI audit engine. It analyzed 30+ dimensions of
              your online presence in under 30 seconds.
            </Text>
          </Section>
