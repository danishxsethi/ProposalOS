...
import { Activity, FileText, PieChart, Plus, TrendingUp } from 'lucide-react';
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            asChild
            className="bg-accent-primary hover:bg-accent-primary/90 text-white font-semibold shadow-lg shadow-accent-primary/20"
          >
            <Link href="/scan">
