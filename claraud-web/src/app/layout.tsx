...
export const metadata: Metadata = {
  ...
  description: 'Free 30-second AI audit of your website, Google presence, competitors, reviews, and social media. Get a personalized action plan to grow.',
  keywords: ['website audit', 'business audit', 'SEO audit', 'Google Business Profile', 'marketing audit', 'free website audit'],
