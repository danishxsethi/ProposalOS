...
function mergeContact(
  base: EnrichedContact | null,
  next: EnrichedContact | null
  ...
  try {
    ...
    return {
      ...
      contact: {
        ...
        linkedin:
          typeof person.linkedin_profile_url === 'string' ? person.linkedin_profile_url : null,
      },
    };
  } catch (error) {
    return {
