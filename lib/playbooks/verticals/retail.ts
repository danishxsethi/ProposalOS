...
export const retailPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    ...
    },
    {
      ...
      recommendation:
        'Streamline checkout to 3 steps or less. Guest checkout and saved payment info boost conversion.',
    },
    {
      id: 'payment_options',
      ...
      recommendation:
        'Offer credit, debit, e-transfer, Apple Pay, and Google Pay. Canadians expect multiple options.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Add "check availability" or store locator for local pickup. Your advantage is local trust.',
    },
    {
  ...
  proposalLanguage: {
    ...
    executiveSummaryOpening:
      'Saskatoon shoppers compare local retailers online — your site speed and checkout UX decide who buys.',
  },
  ...
  locationContext: {
    ...
    currency: 'CAD',
    competitiveDensity:
      'Saskatoon retailers compete with national chains — local trust and UX win.',
    regulatoryContext: [
      'CASL (email marketing)',
      'PIPEDA (customer data)',
