  ...
  it('should hard-fail a generic summary with no quantified impact', () => {
    const mockProposal: any = {
      ...
      tiers: {
        essentials: {
          findingIds: ['1'],
          roi: { scenarios: { best: 100, base: 80, worst: 60, assumptions: ['A1', 'A2'] } },
        },
        growth: {
          findingIds: ['1'],
          roi: { scenarios: { best: 120, base: 90, worst: 70, assumptions: ['A1', 'A2'] } },
        },
        premium: {
          findingIds: ['1'],
          roi: { scenarios: { best: 140, base: 100, worst: 80, assumptions: ['A1', 'A2'] } },
        },
      },
      pricing: { essentials: 500, growth: 1000, premium: 2000 },
      assumptions: ['Assumption 1', 'Assumption 2'],
