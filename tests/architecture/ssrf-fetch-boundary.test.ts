...
const ALLOWED_RAW_FETCH: AllowedRawFetch[] = [
  ...
  },
  {
    ...
    line: 115,
    host: 'api.apollo.io',
    reason: 'Fixed host; Apollo People Search API — user businessName in POST body only',
  },
  {
    file: 'lib/outreach/sprint2/enrichment.ts',
    line: 211,
    host: 'api.hunter.io',
    reason: 'Fixed host; Hunter domain-search API — domain in query param',
  },
  {
    file: 'lib/outreach/sprint2/enrichment.ts',
    line: 301,
    host: 'nubela.co',
    reason: 'Fixed host; Proxycurl LinkedIn API — domain in query param',
  },
  {
    file: 'lib/outreach/sprint2/enrichment.ts',
    line: 386,
    host: 'person.clearbit.com',
    reason: 'Fixed host; Clearbit Combined API — domain in query param',
  },
  {
    file: 'lib/outreach/sprint2/enrichment.ts',
    line: 462,
    host: 'api.zerobounce.net',
    reason: 'Fixed host; ZeroBounce email validation — email in query param',
  },
  {
    file: 'lib/outreach/sprint2/enrichment.ts',
    line: 496,
    host: 'serpapi.com',
    reason: 'Fixed host; SerpAPI search — query in params',
  },
  {
