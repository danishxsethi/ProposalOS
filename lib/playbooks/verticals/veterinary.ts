...
export const veterinaryPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    {
      ...
      recommendation:
        'Display emergency number and after-hours instructions above the fold on mobile.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Create a services page with descriptions (wellness, surgery, dental, emergency, etc.).',
    },
    {
      id: 'pet_portal_login',
      ...
      recommendation:
        'Add a client portal for vaccination records, appointment history, and online requests.',
    },
    {
      ...
      recommendation:
        'Offer new client forms online to reduce wait time and improve first impressions.',
    },
    {
      ...
      recommendation:
        'Encourage reviews that mention vet names — "Dr. Smith was wonderful" builds trust.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Add FAQ, blog posts, or guides (puppy care, senior pets) to build authority.',
    },
    {
      id: 'pipeda_privacy',
  ...
  proposalLanguage: {
    ...
    socialProof:
      "We've helped 35+ Saskatchewan veterinary clinics attract more pet owners and fill their schedules.",
    urgencyHook:
      'Pet owners are emotionally invested — they choose a vet they trust. Your site must build that trust in seconds.',
    roiFraming: 'Each new client represents $175+ in average lifetime value per visit.',
    executiveSummaryOpening:
      'Saskatoon pet owners search for vets when they need one — your site and emergency visibility matter.',
  },
  ...
  locationContext: {
    ...
    regulatoryContext: [
      'PIPEDA (client/pet data)',
      'Saskatchewan Veterinary Medical Association',
      'CASL (appointment reminders)',
    ],
  },
};
