    ...
    <SectionWrapper id="industries">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white">
          Built for your industry. <span className="gradient-text">Not generic advice.</span>
        </h2>
      </motion.div>
          ...
          {industries.map((industry, idx) => (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-text-primary font-medium px-3 py-1.5 bg-white/5 rounded-lg border border-white/10">
                  {industry.topIssue}
                </p>
              </div>
