...
export const TEST_URLS: TestUrl[] = [
  ...
  { url: 'https://www.hg.org', businessName: 'HG.org', city: 'Clearwater', industry: 'legal' },
  {
    ...
    businessName: 'Super Lawyers',
    city: 'Minneapolis',
    industry: 'legal',
  },
  {
    url: 'https://www.martry.com',
    businessName: 'Martindale-Hubbell',
    city: 'New Providence',
    industry: 'legal',
  },
  {
    url: 'https://www.legalmatch.com',
    businessName: 'LegalMatch',
    city: 'San Francisco',
    industry: 'legal',
  },
  {
    url: 'https://www.upcounsel.com',
    businessName: 'UpCounsel',
    city: 'San Francisco',
    industry: 'legal',
  },
  ...
  // Dental (10)
  {
    ...
    businessName: 'American Dental Association',
    city: 'Chicago',
    industry: 'dental',
  },
  {
    url: 'https://www.deltadental.com',
    businessName: 'Delta Dental',
    city: 'San Francisco',
    industry: 'dental',
  },
  {
  ...
  {
    url: 'https://www.heartlanddental.com',
    businessName: 'Heartland Dental',
    city: 'Effingham',
    industry: 'dental',
  },
  {
    url: 'https://www.sage-dental.com',
    businessName: 'Sage Dental',
    city: 'West Palm Beach',
    industry: 'dental',
  },
  {
    url: 'https://www.benjaminfamilydentistry.com',
    businessName: 'Benjamin Family Dentistry',
    city: 'Elk Grove',
    industry: 'dental',
  },
  {
    url: 'https://www.dentistry.com',
    businessName: 'Dentistry.com',
    city: 'New York',
    industry: 'dental',
  },
  {
    url: 'https://www.123dentist.com',
    businessName: '123 Dentist',
    city: 'Phoenix',
    industry: 'dental',
  },
  {
    url: 'https://www.dentalplans.com',
    businessName: 'DentalPlans',
    city: 'Plantation',
    industry: 'dental',
  },
  ...
  },
  {
    ...
    businessName: 'Johns Hopkins Medicine',
    city: 'Baltimore',
    industry: 'medical',
  },
  {
    url: 'https://www.massgeneral.org',
    businessName: 'Massachusetts General Hospital',
    city: 'Boston',
    industry: 'medical',
  },
  {
    url: 'https://www.uclahealth.org',
    businessName: 'UCLA Health',
    city: 'Los Angeles',
    industry: 'medical',
  },
  {
    url: 'https://www.stanfordhealthcare.org',
    businessName: 'Stanford Health Care',
    city: 'Stanford',
    industry: 'medical',
  },
  {
    url: 'https://www.nyuhs.org',
    businessName: 'NYU Langone Health',
    city: 'New York',
    industry: 'medical',
  },
  {
    url: 'https://www.cedars-sinai.org',
    businessName: 'Cedars-Sinai',
    city: 'Los Angeles',
    industry: 'medical',
  },
  {
    url: 'https://www.mountsinai.org',
    businessName: 'Mount Sinai',
    city: 'New York',
    industry: 'medical',
  },
  {
    url: 'https://www.northwesternmedicine.org',
    businessName: 'Northwestern Medicine',
    city: 'Chicago',
    industry: 'medical',
  },
  ...
  },
  {
    ...
    businessName: 'McCarthy',
    city: 'Irving',
    industry: 'construction',
  },
  {
    url: 'https://www.henselphelps.com',
    businessName: 'Hensel Phelps',
    city: 'Greeley',
    industry: 'construction',
  },
  ...
  },
  {
    ...
    businessName: 'Mr. Rooter Plumbing',
    city: 'Waco',
    industry: 'plumbing',
  },
  {
    url: 'https://www.benjaminfranklinplumbing.com',
    businessName: 'Benjamin Franklin Plumbing',
    city: 'Waco',
    industry: 'plumbing',
  },
  {
    url: 'https://www.abcplumbing.com',
    businessName: 'ABC Home & Commercial Services',
    city: 'Austin',
    industry: 'plumbing',
  },
  {
    url: 'https://www.johnsonplumbing.com',
    businessName: 'Johnson Plumbing',
    city: 'Phoenix',
    industry: 'plumbing',
  },
  {
    url: 'https://www.horizonplumbing.com',
    businessName: 'Horizon Plumbing',
    city: 'Denver',
    industry: 'plumbing',
  },
  {
    url: 'https://www.plumbingsolutions.com',
    businessName: 'Plumbing Solutions',
    city: 'Las Vegas',
    industry: 'plumbing',
  },
  {
    url: 'https://www.expressplumbing.com',
    businessName: 'Express Plumbing',
    city: 'Houston',
    industry: 'plumbing',
  },
  {
    url: 'https://www.superiorplumbing.com',
    businessName: 'Superior Plumbing',
    city: 'Atlanta',
    industry: 'plumbing',
  },
  {
    url: 'https://www.qualityplumbing.com',
  ...
  {
    url: 'https://www.daynight.com',
    businessName: 'Day & Night',
    city: 'Indianapolis',
    industry: 'hvac',
  },
  ...
  },
  {
    ...
    businessName: 'HotPads',
    city: 'San Francisco',
    industry: 'real_estate',
  },
  {
    url: 'https://www.apartments.com',
    businessName: 'Apartments.com',
    city: 'Atlanta',
    industry: 'real_estate',
  },
  {
    url: 'https://www.rent.com',
    businessName: 'Rent.com',
    city: 'Irvine',
    industry: 'real_estate',
  },
  {
  ...
  { url: 'https://www.gaf.com', businessName: 'GAF', city: 'Parsippany', industry: 'roofing' },
  {
    ...
    businessName: 'Owens Corning',
    city: 'Toledo',
    industry: 'roofing',
  },
  {
    url: 'https://www.certainteed.com',
    businessName: 'CertainTeed',
    city: 'Malvern',
    industry: 'roofing',
  },
  {
  ...
  {
    url: 'https://www.malarkeyroofing.com',
    businessName: 'Malarkey Roofing',
    city: 'Vancouver',
    industry: 'roofing',
  },
  {
    url: 'https://www.ikoroofing.com',
    businessName: 'IKO Roofing',
    city: 'Brampton',
    industry: 'roofing',
  },
  {
    url: 'https://www.pabcoroofing.com',
    businessName: 'PABCO Roofing',
    city: 'City of Industry',
    industry: 'roofing',
  },
  { url: 'https://www.tamko.com', businessName: 'TAMKO', city: 'Joplin', industry: 'roofing' },
  {
    url: 'https://www.duro-last.com',
    businessName: 'Duro-Last',
    city: 'Saginaw',
    industry: 'roofing',
  },
  {
    url: 'https://www.firestonebpco.com',
    businessName: 'Firestone Building Products',
    city: 'Nashville',
    industry: 'roofing',
  },
...
export async function verifyFinding(
  ...
  if (
    finding.metrics &&
    typeof finding.metrics === 'object' &&
    Object.keys(finding.metrics).length > 0
  ) {
    const metricValues = Object.values(finding.metrics).filter(
...
export async function runFullAccuracyTest(): Promise<{
  ...
  const accuracyRate =
    totalFindings > 0 ? (totalFindings - hallucinatedFindings) / totalFindings : 0;
