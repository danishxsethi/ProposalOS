    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 w-full">
      {AUDIT_CATEGORIES.map((category) => {
        ...
        return (
          ...
          >
            <Card
              className={`relative overflow-hidden p-6 h-full flex flex-col items-center text-center transition-all duration-500 border-2 ${
                status === 'scanning'
            ...
            >
              ...
              {/* Text info */}
              <h3
                className={`font-semibold text-sm mb-1 ${status === 'pending' ? 'text-white/40' : 'text-white'}`}
              >
                {category.name}
              </h3>
