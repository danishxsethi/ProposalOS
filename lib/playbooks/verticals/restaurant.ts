...
export const restaurantPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    {
      ...
      recommendation:
        'Convert the menu to HTML for SEO and mobile readability. PDFs cannot be indexed properly.',
    },
    {
      id: 'online_ordering',
      ...
      recommendation:
        'Add online ordering or link to Skip The Dishes, DoorDash, or your own ordering system.',
    },
    {
      ...
      recommendation:
        'Keep Google Business hours up to date, including holidays and special hours.',
    },
    {
      id: 'gbp_photos',
      ...
      recommendation:
        'Add 10+ high-quality photos (food, interior, exterior) and update regularly.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'List allergens and dietary options — 30%+ of diners have dietary restrictions.',
    },
    {
      ...
      recommendation:
        'Optimise for mobile speed — hungry customers will pick the next restaurant on Google.',
    },
    {
  ...
  proposalLanguage: {
    ...
    executiveSummaryOpening:
      'Saskatoon diners search for restaurants on their phones — your site has seconds to convert.',
  },
  ...
  locationContext: {
    ...
    currency: 'CAD',
    competitiveDensity:
      'Saskatoon has 400+ restaurants — your Google listing and site speed determine who gets the click.',
    regulatoryContext: [
      'Saskatchewan Food Safety',
      'Liquor licensing',
      'CASL (email for promotions)',
    ],
    neighbourhoods: [
      'Downtown',
      'Broadway',
