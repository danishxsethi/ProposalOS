            ...
            {flags.map((flag) => (
              <tr key={flag.id} className="border-t border-slate-800">
                ...
                <td className="p-4 py-3">
                  ...
                  >
                    <div
                      className={`absolute top-1 w-3 h-3 bg-white rounded-full transition-all ${flag.enabled ? 'left-6' : 'left-1'}`}
                    />
                  </button>
                </td>
                <td className="p-4 py-3">
                ...
                <td className="p-4 py-3">
                  <button className="text-indigo-400 hover:text-white px-2 py-1 bg-indigo-500/10 rounded text-xs">
                    Configure
                  </button>
                </td>
              </tr>
