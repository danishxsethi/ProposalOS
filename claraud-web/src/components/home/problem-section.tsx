    ...
    <SectionWrapper id="problem-section" className="text-center">
      ...
      >
        {problems.map((problem, idx) => (
          ...
          >
            <div className="mb-6 p-4 bg-white/5 rounded-full inline-flex">{problem.icon}</div>
            <h3 className="text-lg font-semibold text-white mb-4 leading-snug">{problem.title}</h3>
            <p className="text-sm text-text-secondary mt-auto">{problem.stat}</p>
          </motion.div>
        ))}
      </motion.div>
