...
const publicRoutes = ["/", "/scan", "/pricing", "/agencies", "/blog", "/login", "/register", "/about"]

const publicPrefixes = ["/scan/", "/report/", "/proposal/", "/presentation/", "/api/og/", "/api/lead", "/api/health", "/api/scan", "/industries/", "/legal/"]
