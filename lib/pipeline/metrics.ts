...
import { type DateRange, type PipelineMetrics, PipelineStage } from './types';
 ...
 */
export async function getMetrics(tenantId: string, period: DateRange): Promise<PipelineMetrics> {
