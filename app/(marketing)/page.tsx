    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-white mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">
              outperforms agencies.
            </span>
          </h1>

          <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Analyze 15+ data points. Generate a consulting-grade report in 90 seconds. Cost: $0.20
            per audit.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
            <Link
              href="/free-audit"
              className="w-full sm:w-auto px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-bold text-lg shadow-[0_0_40px_-10px_rgba(99,102,241,0.5)] transition hover:scale-105"
            >
              Audit Any Business Free
            </Link>
            <Link
              href="/demo/sample-report"
              className="w-full sm:w-auto px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-bold text-lg border border-slate-700 transition"
            >
              View Sample Report
            </Link>
          </div>
      ...
      <section className="py-12 border-y border-white/5 bg-slate-900/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-sm text-slate-400">
            <span className="font-bold text-white">{auditCount.toLocaleString()}</span> businesses
            audited this month
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
              Consulting-grade results. <br />
              Zero consulting hours.
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-slate-400">
                Just a name and URL. Our system identifies location and industry automatically.
              </p>
            </div>
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-slate-400">
                We scan website performance, SEO, competitors, and 15+ other signals in real-time.
              </p>
            </div>
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-slate-400">
                Get a white-labeled PDF report and a pre-written proposal to send to the client.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-400 mb-8">
                Stop manually screengrabbing and copy-pasting. ProposalOS standardizes your audit
                process.
              </p>
      ...
      <section className="py-32 bg-slate-950 relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center max-w-3xl">
          ...
          <Link
            href="/free-audit"
            className="inline-block px-8 py-5 bg-white text-slate-950 rounded-xl font-black text-xl hover:bg-slate-200 transition transform hover:scale-105 shadow-2xl"
          >
            Run Your First Audit Free
          </Link>
          <p className="mt-6 text-slate-500">
            Or{' '}
            <Link href="/demo/sample-report" className="underline hover:text-white">
