...
export const generalPlaybook: VerticalPlaybook = {
  ...
  verticalSpecificFindings: [
    {
      ...
      recommendation:
        'Optimize images, enable caching, and reduce server response time. Target under 3 seconds.',
    },
    {
    ...
    },
    {
      ...
      recommendation:
        'Display phone, email, and address above the fold. Add click-to-call on mobile.',
    },
    {
      id: 'trust_signals',
  ...
  proposalLanguage: {
    ...
    socialProof:
      "We've helped 200+ local businesses improve their online presence and win more customers.",
    urgencyHook:
      'Most customers research online before contacting. A slow or confusing site loses them.',
  },
