...
const COMPETITOR_DATA: Record<string, Record<string, Competitor[]>> = {
  ...
  'de-DE': {
    dental: [
      {
        ...
        name: 'Zahnarzt Berlin',
        locale: 'de-DE',
        industry: 'dental',
        searchEngine: 'Google',
      },
      {
        domain: 'dental-praxis.de',
        name: 'Dental Praxis',
        locale: 'de-DE',
        industry: 'dental',
        searchEngine: 'Google',
    ...
    restaurant: [
      {
        domain: 'restaurant-muenchen.de',
        name: 'Restaurant München',
        locale: 'de-DE',
        industry: 'restaurant',
        searchEngine: 'Google',
      },
  ...
  'ru-RU': {
    dental: [
      {
        domain: 'stomatolog-moskva.ru',
        name: 'Стоматолог Москва',
        locale: 'ru-RU',
        industry: 'dental',
        searchEngine: 'Yandex',
      },
...
export class CompetitorAnalysisLocalizer {
   ...
   * Requirement 5.3
   */
  async getLocaleSpecificMetrics(competitor: Competitor, locale: string): Promise<LocaleMetrics> {
    const searchEngine = this.searchEngineAdapter.getCompetitorAnalysisEngine(locale);
